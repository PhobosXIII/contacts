...
import com.example.phobos.contacts.ContactDetailActivity
import com.example.phobos.contacts.ContactDetailFragment
import com.example.phobos.contacts.ContactListFragment
import com.example.phobos.contacts.R
 ...
 */
public class ContactListActivity : FragmentActivity(), ContactListFragment.Callbacks {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (findViewById(R.id.contact_detail_container) != null) {
            ...
            (getSupportFragmentManager().findFragmentById(R.id.contact_list) as ContactListFragment).setActivateOnItemClick(true)
        }
    ...
    override fun onItemSelected(id: String) {
        if (mTwoPane) {
            ...
            val detailIntent = Intent(this, javaClass<ContactDetailActivity>())
